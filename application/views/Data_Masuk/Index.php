                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="text-muted font-semibold">Data Masuk Hari Ini</h6>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="text-muted font-semibold">Data Masuk Bulan Ini</h6>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="text-muted font-semibold">Data Masuk Tahun Ini</h6>
                                                <h6 class="font-extrabold mb-0">183.000 Kendaraan</h6>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="text-muted font-semibold">Total Data Masuk</h6>
                                                <h6 class="font-extrabold mb-0">183.000 Kendaraan</h6>
                                            </div>
                                        </div>
                                    </div>
